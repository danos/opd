...
/*
    ...
    slave name is passed as one of the arguments to the
    cmdrunner. This is done through the opd Run RPC. Run now blocks
    until the process exits and returns the exit code from the opd
    child.
